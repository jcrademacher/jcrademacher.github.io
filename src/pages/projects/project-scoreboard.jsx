...
import headerImage from '../../media/scoreboard/scoreboard_thumb.jpeg'
import thumbnail from '../../media/scoreboard/scoreboard_thumb.jpeg?thumbnail'
import moment from 'moment';

export default function ScoreboardProject() {
    return (
        <div>
